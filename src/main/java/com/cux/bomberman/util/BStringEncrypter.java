...
public class BStringEncrypter {
     ...
     *                   decrypter instances.
     */
    public BStringEncrypter(SecretKey key, String algorithm) {
        try {
     ...
     *                   decrypter instances.
     */
    public BStringEncrypter(String passPhrase) {
...
//            return BBase64.encode(new String(enc, "UTF8"));
...
//            byte[] dec = BBase64.decode(str).getBytes("UTF8");
    ...
    public static void testUsingSecretKey() {
        try {
            ...
            BStringEncrypter desEncrypter = new BStringEncrypter(desKey, desKey.getAlgorithm());
            BStringEncrypter blowfishEncrypter = new BStringEncrypter(blowfishKey, blowfishKey.getAlgorithm());
            BStringEncrypter desedeEncrypter = new BStringEncrypter(desedeKey, desedeKey.getAlgorithm());
    ...
    public static void testUsingPassPhrase() {
        ...
        // Create encrypter/decrypter class
        BStringEncrypter desEncrypter = new BStringEncrypter(passPhrase);
